...
MatrixDescription = {'Each cell is a region, with phase data w.in each cell'}
fn = 'Fig4AND5j.mat';

cd('/mnt/yassamri/iEEG/sandra/NatComSourceData')

save(fn,'phaseDataPerRegion_channelPairPhaseTransferEntropy',...
    'phaseLength','phaseNames','regionLength','regionNames', 'MatrixDescription')
