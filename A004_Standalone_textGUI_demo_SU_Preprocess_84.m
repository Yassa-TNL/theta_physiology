...
paths.basePath='/media/SSanDra/Pattern_Separation/subj_84/';    
paths.pathOut=[paths.basePath 'mram/osort_output/'];
paths.pathRaw=[paths.basePath ];
paths.pathFigs=[paths.basePath 'mram/figures'];
...
paths.patientID= 'IR84'; % label in plots

filesToProcess = [1:8];  %which channels to detect/sort
...
paramsIn.rawFilePrefix= 'mram';        % some systems use CSC instead of A
...
paramsIn.minNrSpikes=200; %min nr spikes assigned to a cluster for it to be valid
...
paramsIn.peakAlignMethod=4; %1 find Peak, 2 none, 3 peak of power, 4 MTEO peak
