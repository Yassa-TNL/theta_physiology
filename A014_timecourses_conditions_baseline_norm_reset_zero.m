...
temp = squeeze(nanmean(mn_acrs_trials_cond1(counter_freq_range,stim_onset:end,chan_idx),1))';
stdshade_subt_mean(temp,.1,'b',[],[])
h1 = plot(nanmean(temp,1)-mean(temp(:,1)), 'b', 'LineWidth', 2)
clear temp

temp = squeeze(nanmean(mn_acrs_trials_cond2(counter_freq_range,stim_onset:end,chan_idx),1))';
stdshade_subt_mean(temp,.1,'g',[],[])
h2 = plot(nanmean(temp,1)-mean(temp(:,1)), 'g', 'LineWidth', 2)
clear temp

temp = squeeze(nanmean(mn_acrs_trials_cond3(counter_freq_range,stim_onset:end,chan_idx),1))';
stdshade_subt_mean(temp,.1,'r',[],[])
h3 = plot(nanmean(temp,1)-mean(temp(:,1)), 'r', 'LineWidth', 2)
clear temp

temp = squeeze(nanmean(mn_acrs_trials_cond4(counter_freq_range,stim_onset:end,chan_idx),1))';
stdshade_subt_mean(temp,.1,'m',[],[])
h4 = plot(nanmean(temp,1)-mean(temp(:,1)), 'm', 'LineWidth', 2)
clear temp

%xlim([0 800])
%ylim([-.3 .6])
title (['frontal cortex' ; num2str(freq_ranges(1)) '-' num2str(freq_ranges(2)) ' hz power'])
...
%xlim([0 800])
%ylim([-.3 .6])
title (['    MTL       ';  num2str(freq_ranges(1)) '-' num2str(freq_ranges(2)) ' hz power'])
xlabel('time from stim onset')
ylabel('z-score power')
legend([h1 h2 h3 h4 ], 'rep','incorr lure', 'corr lure', 'new')
set(gca, 'FontSize', 14, 'FontWeight', 'bold')
...
%xlim([0 800])
%ylim([-.3 .6])
title (['temporal lobe '; num2str(freq_ranges(1)) '-' num2str(freq_ranges(2)) ' hz power'])
xlabel('time from stim onset')
ylabel('z-score power')
legend([h1 h2 h3 h4 ], 'rep','incorr lure', 'corr lure', 'new')
set(gca, 'FontSize', 14, 'FontWeight', 'bold')
...
%xlim([0 800])
%ylim([-.3 .6])
title (['      OFC     '; num2str(freq_ranges(1)) '-' num2str(freq_ranges(2)) ' hz power'])
xlabel('time from stim onset')
ylabel('z-score power')
legend([h1 h2 h3 h4 ], 'rep','incorr lure', 'corr lure', 'new')
set(gca, 'FontSize', 14, 'FontWeight', 'bold')
...
%xlim([0 800])
%ylim([-.3 .6])
title (['   cingulate  '; num2str(freq_ranges(1)) '-' num2str(freq_ranges(2)) ' hz power'])
xlabel('time from stim onset')
ylabel('z-score power')
legend([h1 h2 h3 h4 ], 'rep','incorr lure', 'corr lure', 'new')
set(gca, 'FontSize', 14, 'FontWeight', 'bold')
...
%xlim([0 800])
%ylim([-.3 .6])
title (['    insula    '; num2str(freq_ranges(1)) '-' num2str(freq_ranges(2)) ' hz power'])
xlabel('time from stim onset')
ylabel('z-score power')
legend([h1 h2 h3 h4 ], 'rep','incorr lure', 'corr lure', 'new')
set(gca, 'FontSize', 14, 'FontWeight', 'bold')