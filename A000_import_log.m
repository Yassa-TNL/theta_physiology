function MDTOlog = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MDTOLOG = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MDTOLOG = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   MDTOlog = importfile('39_MDTO_log.txt', 1, 171);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/07/24 15:27:26
