...
% condition pairs
% study-R
pair_1a        = find(training_behav_matrix(:,2)== 0);
pair_1a_images = train_images(pair_1a)
[IDX1 IDX2]    = ismember(test_images,pair_1a_images);
...
% study-sim1
pair_2a        = find(training_behav_matrix(:,2)== 1);
pair_2a_images = train_images(pair_2a)
for trial = 1:length(pair_2a_images)
  pair_2b_images{trial,1} =   [pair_2a_images{trial}(1:3) 'b' pair_2a_images{trial}(5:end)]
end
[IDX1 IDX2]    = ismember(test_images,pair_2b_images);
IDX3 = [find(IDX1) IDX2(IDX1)]
IDX4 = sortrows(IDX3,2)
pair_2b = IDX4(:,1)
...
% study-sim2
pair_3a        = find(training_behav_matrix(:,2)== 2);
pair_3a_images = train_images(pair_3a)
for trial = 1:length(pair_3a_images)
  pair_3b_images{trial,1} =   [pair_3a_images{trial}(1:3) 'b' pair_3a_images{trial}(5:end)]
end
[IDX1 IDX2]    = ismember(test_images,pair_3b_images);
IDX3 = [find(IDX1) IDX2(IDX1)]
IDX4 = sortrows(IDX3,2)
pair_3b = IDX4(:,1)
...
% study-sim3
pair_4a        = find(training_behav_matrix(:,2)== 4);
pair_4a_images = train_images(pair_4a)
for trial = 1:length(pair_4a_images)
  pair_4b_images{trial,1} =   [pair_4a_images{trial}(1:3) 'b' pair_4a_images{trial}(5:end)]
end
[IDX1 IDX2]    = ismember(test_images,pair_4b_images);
IDX3 = [find(IDX1) IDX2(IDX1)]
IDX4 = sortrows(IDX3,2)
pair_4b = IDX4(:,1)
...
% study-sim5
pair_5a        = find(training_behav_matrix(:,2)== 5);
pair_5a_images = train_images(pair_5a)
for trial = 1:length(pair_5a_images)
  pair_5b_images{trial,1} =   [pair_5a_images{trial}(1:3) 'b' pair_5a_images{trial}(5:end)]
end
[IDX1 IDX2]    = ismember(test_images,pair_5b_images);
IDX3 = [find(IDX1) IDX2(IDX1)]
IDX4 = sortrows(IDX3,2)
pair_5b = IDX4(:,1)
...
% study-sim6
pair_6b  = find(testing_behav_matrix(:,2) == .5);
...
HC_end       = stim_onset+300; % old was 330
